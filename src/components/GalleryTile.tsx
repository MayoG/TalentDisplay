...
export function GalleryTile({ image, layoutClassName }: GalleryTileProps) {
  const aspectClass =
    image.span === "wide"
  ...
  return (
    <motion.figure
      variants={fadeUp}
      className={`group relative min-h-0 overflow-hidden rounded-sm border border-white/10 bg-stage-smoke ${layoutClassName}`}
    >
